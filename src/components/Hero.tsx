  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden px-4 py-20 bg-dark selection:bg-brand selection:text-dark">
      ...
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between overflow-hidden">
        <h1 className="text-[20vw] font-anton leading-[0.8] text-zinc-800 whitespace-nowrap opacity-30 -ml-10 select-none">PRZEPROWADZKI</h1>
        <h1 className="text-[20vw] font-anton leading-[0.8] text-zinc-800 whitespace-nowrap opacity-30 text-right -mr-10 select-none">BIAŁYSTOK</h1>
      </div>
      ...
      >
        ...
        <p className="text-lg md:text-2xl text-zinc-300 max-w-2xl text-center font-medium leading-relaxed bg-dark/50 backdrop-blur-sm p-4 border border-zinc-800 rounded-sm">
          Opróżnianie mieszkań, montaż mebli, wnoszenie i znoszenie. 
          Jesteśmy do dyspozycji <strong className="text-brand">7 dni w tygodniu</strong>.
        </p>
        ...
        <p className="font-anton text-zinc-500 uppercase tracking-widest text-sm">Zadzwoń do Maćka</p>
      </motion.div>
    </section>
  );
}